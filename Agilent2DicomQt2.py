...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "Agilent2Dicom: MBI\'s Agilent 9.4T MR Image Analysis and Dicom Converter Application (2.0.3", None))
...
"or B1 image", None))
        ...
        self.Version_tag.setText(_translate("MainWindow", "Agilent2Dicom v2.0.3", None))
