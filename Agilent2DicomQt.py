...
#
# Created: Tue Oct 28 14:08:09 2014
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_12 = QtGui.QLabel(self.tab_fdf_2)
        ...
        self.verticalLayout_11 = QtGui.QVBoxLayout(self.tab_diffusion)
        ...
        self.Multiecho_2.addTab(self.tab_diffusion, _fromUtf8(""))
        ...
        self.verticalLayout_12 = QtGui.QVBoxLayout(self.tab_multiecho)
        ...
        self.Multiecho_2.addTab(self.tab_multiecho, _fromUtf8(""))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_12.setText(_translate("MainWindow", "Options", None))
        ...
        self.Multiecho_2.setTabText(self.Multiecho_2.indexOf(self.tab_generic_2), _translate("MainWindow", "Generic", None))
        self.radioButton_bmatrixdiff.setText(_translate("MainWindow", "Bmatrix", None))
        self.radioButton_directionaldiff.setText(_translate("MainWindow", "Directional", None))
        self.label_18.setText(_translate("MainWindow", "TextLabel", None))
        self.checkBox_diffusion1.setText(_translate("MainWindow", "Diffusion", None))
        self.Multiecho_2.setTabText(self.Multiecho_2.indexOf(self.tab_diffusion), _translate("MainWindow", "Diffusion", None))
        self.label_21.setText(_translate("MainWindow", "Echo Train List", None))
        self.checkBox_8.setText(_translate("MainWindow", "Multi-echo", None))
        self.Multiecho_2.setTabText(self.Multiecho_2.indexOf(self.tab_multiecho), _translate("MainWindow", "Multi echo", None))
        self.pushButton_convert.setToolTip(_translate("MainWindow", "Convert FDF folder to DICOM", None))
        ...
        self.pushButton_convertfid.setToolTip(_translate("MainWindow", "Run the fid2dcm script", None))
        self.pushButton_convertfid.setText(_translate("MainWindow", "Convert", None))
        self.pushButton_check2.setToolTip(_translate("MainWindow", "Check the unfiltered reconstruction DICM", None))
        self.pushButton_check2.setText(_translate("MainWindow", "Check", None))
        self.pushButton_view2.setToolTip(_translate("MainWindow", "View the filtered and unfiltered images", None))
        ...
        self.tabWidget_3.setToolTip(_translate("MainWindow", "Multidimensional median, Gaussian or Wiener  filters.", None))
...
"\n"
"    Standard deviation for Gaussian kernel. The standard deviations of the Gaussian filter are given for each axis as a sequence, or as a single number, in which case it is equal for all axes.", None))
        self.lineEdit_gsigma.setText(_translate("MainWindow", "0.707", None))
...
"    Multidimensional Gaussian filter.", None))
        self.checkBox_gaussian.setText(_translate("MainWindow", "Use Gaussian Filter", None))
...
"", None))
        ...
        self.label_36.setText(_translate("MainWindow", "Outputs of Filter", None))
        ...
        self.label_38.setText(_translate("MainWindow", "Agilent2Dicom v1.2.2", None))
        self.label_37.setText(_translate("MainWindow", "--o--", None))
