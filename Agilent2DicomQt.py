...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 699, 138))
...
" filter(Fourier domain)", None))
        self.checkBox_kspepashift.setToolTip(_translate("MainWindow", "Disable k-space frequency shift.  Before filtering in Fourier domain, the maximum point in the k-space data is placed in the centre of the image. Disabling this may produce unusual effects from the filtering.", None))
