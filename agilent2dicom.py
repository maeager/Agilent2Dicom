...
VersionNumber = "0.6"
DVCSstamp = "$Id: agilent2dicom.py,v dc0163429a2a 2014/10/08 06:37:19 michael $"
...
#            print 'Processing multi-echo sequence image'
        ...
        if SEQUENCE == "ASL":         
            if fdf_properties["asltag"] == 1:
                ds.MRArterialSpinLabeling[0].ASLContext  = 'LABEL'   # (0018,9257)      1C  The purpose of the Arterial Spin Labeling.
            elif  fdf_properties["asltag"] == -1:            #   Enumerated Values:
                ds.MRArterialSpinLabeling[0].ASLContext  = 'CONTROL'                   #           LABEL
#                                                                    CONTROL
            else:
                ds.MRArterialSpinLabeling[0].ASLContext = 'M_ZERO_SCAN'                #            M_ZERO_SCAN
...
#           ds.MRArterialSpinLabelingSequence.ASLSlabSequence[0].ASLMidSlabPosition  = [str(Pxyz[0,0]),str(Pxyz[1,0]),str(Pxyz[2,0]))]
        ...
        if SEQUENCE == 'Diffusion':
            ...
            ds.AcquisitionNumber = BValueSortIdx[diffusion_idx] # Sort diffusion based on sorted index of Bvalue instead of fdf_properties['array_index']
