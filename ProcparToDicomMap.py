...
# Save procpar diffusion parameters
    ...
    # in the synchronization Module in Acquisition Time synchronized
    # (0018,1800).
...
# procpar['dgdelay'])
    ...
    # ds.AcquisitionMatrix  = [ AcqMatrix1  , AcqMatrix2  ]   # 0018,1310
    # Acquisition Matrix (optional)
    ...
    # These pixel spacing lines are identical due to the code used for ds.Rows
    # and ds.Columns
    if MRAcquisitionType == '3D':
